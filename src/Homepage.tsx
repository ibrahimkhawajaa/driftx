...
function Homepage() {
  ...
  const filteredProperties = activePropertyTab === 'all' 
    ? allProperties 
  ...
  const realVideos = [
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=600",
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Handpicked selections just for you</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-500">🌟 {featuredProperties.length} Featured</span>
          </div>
        </div>
      ...
      <div className="bg-gray-100 py-16 mt-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Experience the Lifestyle</h2>
            <p className="text-gray-600">See how our clients live in their dream spaces</p>
          </div>
